...
CREATE TABLE IF NOT EXISTS techfab.dim_cliente 
(
...
CREATE TABLE IF NOT EXISTS techfab.dim_produto
(
...
CREATE TABLE IF NOT EXISTS techfab.dim_tempo
(
...
CREATE TABLE IF NOT EXISTS techfab.fato_vendas
(
    sk_produto integer NOT NULL,
    sk_cliente integer NOT NULL,
    sk_localidade integer NOT NULL,
    ...
    CONSTRAINT fato_vendas_sk_cliente_fkey FOREIGN KEY (sk_cliente) REFERENCES techfab.dim_cliente (sk_cliente),
    CONSTRAINT fato_vendas_sk_localidade_fkey FOREIGN KEY (sk_localidade) REFERENCES techfab.dim_localidade (sk_localidade),
    CONSTRAINT fato_vendas_sk_produto_fkey FOREIGN KEY (sk_produto) REFERENCES techfab.dim_produto (sk_produto),
    CONSTRAINT fato_vendas_sk_tempo_fkey FOREIGN KEY (sk_tempo) REFERENCES techfab.dim_tempo (sk_tempo)
);

COPY techfab.dim_cliente
FROM 's3://dsa-projeto2/dados/dim_cliente.csv'
IAM_ROLE 'arn:arn:aws:iam::060795926255:role/RedshiftS3AccessRole'
CSV;
